...
# Add this according to your project structure 
...
class DataValidation: 
    ...
    def validate_numeric_columns( 
        ...
        try: 
            ...
            logging.info( 
                "All numerical columns are valid." 
            ) 
        ...
        try: 
            ...
            if not status: 
                ...
                error_message = ( 
                    ...
                    "all columns as per schema file." 
                ) 
            ...
            status = self.validate_numeric_columns( 
                dataframe=train_dataframe 
            ) 
